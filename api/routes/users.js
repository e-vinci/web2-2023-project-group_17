 ...
 * @param authorize this middleware verify if the request is authorized before allowing to proceed
 */
...
/**
 * @returns the leaderboard sorted by score or an error if no score registered in the leaderboard
 */
